...
import subprocess
import numpy as np
# Do NOT import tensorflow here to prevent premature GPU locking

# Add parent directory to path
sys.path.append(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

from ai_module.preprocessing import get_user_ids, training_data_generator, get_feature_dim
# Do NOT import build_model here yet as it imports TF
...
def train_model(args):
    # 1. Setup GPU Environment Variable BEFORE importing TensorFlow
    ...
    # 2. NOW Import TensorFlow (Lazy Import)
    ...
    try:
        ...
        print(">>> [Step 5] Starting Training (with Early Stopping)...", flush=True)
        EPOCHS = 50
